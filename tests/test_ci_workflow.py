...
class TestCIWorkflow:
    ...
    def test_ci_workflow_triggers(self):
        ...
        assert (
            "develop" in triggers["push"]["branches"]
        ), "Should trigger on develop branch"
        ...
        ), "Should trigger on PRs to main"
        assert (
            "develop" in triggers["pull_request"]["branches"]
        ), "Should trigger on PRs to develop"
    ...
    def test_ci_workflow_coverage_requirement(self):
        ...
        assert (
            "--cov-fail-under=80" in workflow_content
